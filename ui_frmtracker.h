...
public:
    ...
    {
        frmTracker->setWindowTitle(QApplication::translate("frmTracker", "frmTracker", 0, QApplication::UnicodeUTF8));
        lblOriginal->setText(QString());
        lblProcessed->setText(QString());
        btnPauseOrResume->setText(QApplication::translate("frmTracker", "pause", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
